from utils import create_function, get_value, generate_error_graphic, generate_2d_graphic, generate_3d_graphic, generate_gif_linear_regression, generate_countour_line_graphic, generate_3d_gif, generate_residuo_graphic, generate_img_linear_regression
...
if settings["residuos"]["condition"]:
    generate_residuo_graphic(settings["residuos"],dot_list,gradient_descent)
if settings["comparation"]:
    generate_img_linear_regression(regression_dots,dot_list)